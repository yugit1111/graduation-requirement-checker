"use strict";
// ===== DOM =====
const reqSpecializedInput = document.getElementById("reqSpecialized");
const reqGeneralInput = document.getElementById("reqGeneral");
const reqLiberalInput = document.getElementById("reqLiberal"); // 教養追加
...
function renderCourseTable() {
    ...
    courses.forEach((c, i) => {
        ...
        catTd.textContent = c.category;
        const creditTd = document.createElement("td");
        creditTd.textContent = String(c.credits);
